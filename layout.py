...
def build_sidebar():
    return html.Div(style={'width': '100%'}, children=[
        ...
        card([
            ...
            html.Div(id='bol-status', style={'fontSize': '11px', 'color': ACCENT2, 'marginBottom': '6px'}),
            html.Hr(style={'borderColor': BORDER, 'margin': '8px 0'}),
            html.Div('Nova Carteira a Analisar',
                     style={'fontSize': '11px', 'color': ACCENT, 'fontWeight': '600',
                            'marginBottom': '4px'}),
            html.Div('Boletos a pagar — sem histórico de baixa',
                     style={'fontSize': '9px', 'color': MUTED, 'marginBottom': '6px',
                            'fontStyle': 'italic'}),
            dcc.Upload(id='upload-cart', multiple=False,
                       ...
                       children=html.Div([
                           ...
                           html.Div('3. Carteira Nova', style={'fontSize': '12px', 'fontWeight': '600'}),
                           html.Div('carteira_atual.csv', style={'fontSize': '10px', 'color': MUTED}),
                       ], style={'textAlign': 'center', 'padding': '12px'})),
            html.Div(id='cart-status', style={'fontSize': '11px', 'color': WARN, 'marginBottom': '10px'}),
